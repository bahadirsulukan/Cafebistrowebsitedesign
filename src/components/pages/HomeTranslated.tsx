...
import { ArrowRight, Coffee, Utensils, Wine, Clock, MapPin, Star } from 'lucide-react';
...
const menuImages = {
  breakfast: 'https://images.unsplash.com/photo-1685280778004-f9fcf807e30f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxicmVha2Zhc3QlMjBiaXN0cm8lMjBmb29kfGVufDF8fHx8MTc2NzMxMjExOHww&ixlib=rb-4.1.0&q=80&w=1080',
  lunch: 'https://images.unsplash.com/photo-1570818996995-fae698c843f2?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtb2Rlcm4lMjBsdW5jaCUyMHBsYXRlfGVufDF8fHx8MTc2NzMxMjExOXww&ixlib=rb-4.1.0&q=80&w=1080',
  drinks: 'https://images.unsplash.com/photo-1683544599381-be284dbd9abf?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxjb2NrdGFpbCUyMGRyaW5rcyUyMGJhcnxlbnwxfHx8fDE3NjczMTIxMjB8MA&ixlib=rb-4.1.0&q=80&w=1080',
};
    ...
    <div className="overflow-x-hidden">
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        >
          ...
          >
            {t('home.hero.title')}<br />AeroLounge
          </motion.h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            ...
            >
              ...
              >
                <feature.icon className="w-8 h-8" style={{ color: 'var(--cafe-brown-darkest)' }} />
              </motion.div>
              ...
              <Link to="/menu">
                <div className="relative h-80 rounded-2xl overflow-hidden mb-6">
                  ...
                  <motion.div
                    ...
                    transition={{ duration: 0.6 }}
                  >
                    <category.icon className="w-7 h-7" style={{ color: 'var(--cafe-brown-darkest)' }} />
                  </motion.div>
                </div>
                <h3 className="mb-2" style={{ color: 'var(--cafe-brown-darkest)' }}>
                  {category.title}
                </h3>
                <p style={{ color: 'var(--cafe-brown)' }}>{category.description}</p>
              </Link>
            </motion.div>
          ))}
        </div>
  ...
  return (
    ...
    >
      ...
      >
        ...
        <p className="text-lg mb-8 max-w-2xl mx-auto" style={{ color: 'var(--cafe-brown)' }}>
          {t('home.cta.subtitle')}
        </p>
        <Link to="/contact">
          <motion.button
