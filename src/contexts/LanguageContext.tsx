  ...
  de: {
    ...
    home: {
      ...
      menu: {
        ...
        breakfast: {
          title: "Frühstück",
          description:
            "Starten Sie perfekt in den Tag mit unseren frischen Frühstückskreationen",
        },
        lunch: {
          title: "Mittagessen",
      ...
      cta: {
        ...
        subtitle:
          "Reservieren Sie jetzt Ihren Tisch und genießen Sie erstklassigen Service in einzigartigem Ambiente",
    ...
    about: {
      ...
      values: {
        ...
        passion: {
          title: "Leidenschaft",
          description:
            "Wir lieben, was wir tun – von der Kaffeezubereitung bis zum Service",
        },
        quality: {
          title: "Qualität",
          description:
            "Nur die besten Zutaten und frische Zubereitung jeden Tag",
        },
        hospitality: {
      ...
      location: {
        ...
        airport: {
          title: "Flughafennähe",
          description:
            "Nur 5 Minuten vom Flughafen Frankfurt entfernt – perfekt für Reisende vor oder nach dem Flug",
          stat: "5 Min",
        },
        hotels: {
          title: "Hotel-Viertel",
          description:
            "Umgeben von erstklassigen Hotels – ideal für Geschäftsreisende und internationale Gäste",
          stat: "20+",
          statLabel: "Hotels",
        },
    ...
    menu: {
      ...
      items: {
        breakfast: [
          {
            name: "AeroLounge Frühstück",
            description: "Croissant, frisches Obst, Joghurt, Kaffee",
            price: "12.90",
            featured: true,
          },
          {
            name: "Eggs Benedict",
            description: "Pochierte Eier, Hollandaise, Spinat, English Muffin",
            price: "14.50",
          },
          {
            name: "Avocado Toast",
            description: "Sauerteigbrot, Avocado, pochiertes Ei, Microgreens",
            price: "11.90",
          },
          {
            name: "Pancake Stack",
            description: "Ahornsirup, Beeren, Schlagsahne",
            price: "10.50",
          },
          {
            name: "Bircher Müsli",
            description: "Hausgemacht, saisonale Früchte, Nüsse",
            price: "8.90",
          },
          {
            name: "French Toast",
            description: "Brioche, Vanille, karamellisierte Banane",
            price: "11.50",
          },
        ],
        lunch: [
          {
            ...
            description: "Quinoa, geröstetes Gemüse, Zitronenbutter",
            price: "22.90",
          },
          {
            name: "Truffle Burger",
            description: "Rindfleisch, Trüffelmayo, Rucola, Pommes",
            price: "18.50",
          },
          {
            name: "Caesar Salad",
            description:
              "Römersalat, Hähnchenbrust, Parmesan, hausgemachtes Dressing",
            price: "15.90",
          },
          {
            name: "Pasta Carbonara",
            description: "Hausgemachte Tagliatelle, Guanciale, Pecorino",
            price: "16.50",
          },
          {
            name: "Thai Curry Bowl",
            description: "Gemüse, Kokosmilch, Jasminreis, Koriander",
            price: "14.90",
          },
          {
            name: "Wagyu Steak",
            description: "200g, Kartoffelgratin, saisonales Gemüse",
            price: "34.90",
            featured: true,
          },
        ],
        drinks: [
          {
            ...
            description: "Single Origin aus Äthiopien",
            price: "3.50",
            featured: true,
          },
          {
            name: "Cappuccino",
            description: "Doppelter Espresso, aufgeschäumte Milch",
            price: "4.50",
          },
          {
            name: "Cold Brew",
            description: "24h kalt extrahiert, Vanillenote",
            price: "5.20",
          },
          {
            name: "Aviation Cocktail",
            description: "Gin, Maraschino, Crème de Violette, Zitrone",
            price: "12.50",
            featured: true,
          },
          {
            name: "Hugo Spritz",
            description: "Prosecco, Holunderblütensirup, Minze",
            price: "9.50",
          },
          {
            name: "Hausgemachte Limonade",
            description: "Saisonal wechselnde Sorten",
            price: "5.50",
          },
        ],
      },
    ...
    contact: {
      ...
      form: {
        ...
        subtitle:
          "Füllen Sie das Formular aus und wir bestätigen Ihre Reservierung umgehend",
        name: "Name",
        email: "E-Mail",
        phone: "Telefon",
        date: "Datum",
        ...
        persons: "Personen",
        successMessage:
          "Reservierungsanfrage gesendet! Wir melden uns in Kürze bei Ihnen.",
      },
      map: {
        ...
        byCar: "Mit dem Auto:",
        byCarText:
          "Autobahn A5, Ausfahrt Flughafen, Richtung Terminal 1, nach 500m links",
        byPublic: "Öffentliche Verkehrsmittel:",
        byPublicText:
          'S-Bahn S8/S9 bis "Flughafen Regionalbahnhof", 5 Min. Fußweg',
        parking: "Parken:",
    ...
    footer: {
      tagline:
        "Ihr perfekter Zwischenstopp in der Nähe des Flughafens. Genießen Sie erstklassigen Kaffee und frische Küche in modernem Ambiente.",
  ...
  en: {
    ...
    home: {
      ...
      features: {
        ...
        subtitle:
          "Perfect for business travelers, international guests, and anyone who appreciates quality",
        location: {
      ...
      menu: {
        title: "Our Offering",
        subtitle:
          "From early morning to late evening – enjoy culinary highlights",
        breakfast: {
          title: "Breakfast",
          description:
            "Start your day perfectly with our fresh breakfast creations",
        },
        lunch: {
          title: "Lunch",
      ...
      cta: {
        ...
        subtitle:
          "Reserve your table now and enjoy first-class service in a unique ambiance",
        button: "Reserve Now",
      },
    },
    about: {
      ...
      values: {
        ...
        passion: {
          title: "Passion",
          description:
            "We love what we do – from coffee preparation to service",
        },
        quality: {
          title: "Quality",
          description:
            "Only the best ingredients and fresh preparation every day",
        },
        hospitality: {
          title: "Hospitality",
      ...
      location: {
        ...
        airport: {
          ...
          description:
            "Only 5 minutes from Frankfurt Airport – perfect for travelers before or after their flight",
          stat: "5 Min",
        },
        hotels: {
          title: "Hotel District",
          description:
            "Surrounded by first-class hotels – ideal for business travelers and international guests",
          stat: "20+",
          statLabel: "Hotels",
        },
        address: "Flughafenstraße 123, Frankfurt",
    ...
    menu: {
      ...
      items: {
        breakfast: [
          {
            name: "AeroLounge Breakfast",
            description: "Croissant, fresh fruit, yogurt, coffee",
            price: "12.90",
          },
          {
            name: "Eggs Benedict",
            description: "Poached eggs, hollandaise, spinach, English muffin",
            price: "14.50",
          },
          {
            name: "Avocado Toast",
            description: "Sourdough bread, avocado, poached egg, microgreens",
            price: "11.90",
          },
          {
            name: "Pancake Stack",
            description: "Maple syrup, berries, whipped cream",
            price: "10.50",
          },
          {
            name: "Bircher Muesli",
            description: "Homemade, seasonal fruits, nuts",
            price: "8.90",
          },
          {
            name: "French Toast",
            description: "Brioche, vanilla, caramelized banana",
            price: "11.50",
          },
        ],
        lunch: [
          {
            ...
            description: "Quinoa, roasted vegetables, lemon butter",
            price: "22.90",
          },
          {
            name: "Truffle Burger",
            description: "Beef, truffle mayo, arugula, fries",
            price: "18.50",
          },
          {
            name: "Caesar Salad",
            description:
              "Romaine lettuce, chicken breast, parmesan, homemade dressing",
            price: "15.90",
          },
          {
            name: "Pasta Carbonara",
            description: "Homemade tagliatelle, guanciale, pecorino",
            price: "16.50",
          },
          {
            name: "Thai Curry Bowl",
            description: "Vegetables, coconut milk, jasmine rice, cilantro",
            price: "14.90",
          },
          {
            name: "Wagyu Steak",
            description: "200g, potato gratin, seasonal vegetables",
            price: "34.90",
          },
        ],
        drinks: [
          ...
          {
            name: "Cappuccino",
            description: "Double espresso, frothed milk",
            price: "4.50",
          },
          {
            name: "Cold Brew",
            description: "24h cold extraction, vanilla notes",
            price: "5.20",
          },
          {
            name: "Aviation Cocktail",
            description: "Gin, maraschino, crème de violette, lemon",
            price: "12.50",
          },
          {
            name: "Hugo Spritz",
            description: "Prosecco, elderflower syrup, mint",
            price: "9.50",
          },
          {
            name: "Homemade Lemonade",
            description: "Seasonally changing varieties",
            price: "5.50",
          },
        ],
      },
    ...
    contact: {
      ...
      form: {
        ...
        subtitle:
          "Fill out the form and we will confirm your reservation promptly",
        name: "Name",
        email: "Email",
        phone: "Phone",
        date: "Date",
      ...
      map: {
        ...
        byCar: "By Car:",
        byCarText:
          "Highway A5, airport exit, direction Terminal 1, turn left after 500m",
    ...
    footer: {
      tagline:
        "Your perfect stopover near the airport. Enjoy first-class coffee and fresh cuisine in a modern ambiance.",
  ...
  fr: {
    ...
    home: {
      ...
      features: {
        ...
        subtitle:
          "Parfait pour les voyageurs d'affaires, les invités internationaux et tous ceux qui apprécient la qualité",
        location: {
      ...
      menu: {
        ...
        breakfast: {
          ...
          description:
            "Commencez parfaitement la journée avec nos créations fraîches",
        },
        lunch: {
          title: "Déjeuner",
      ...
      cta: {
        ...
        subtitle:
          "Réservez votre table maintenant et profitez d'un service de première classe dans une ambiance unique",
    ...
    about: {
      ...
      values: {
        ...
        passion: {
          title: "Passion",
          description:
            "Nous aimons ce que nous faisons – de la préparation du café au service",
        },
        quality: {
          title: "Qualité",
          description:
            "Seulement les meilleurs ingrédients et une préparation fraîche chaque jour",
        },
        hospitality: {
          title: "Hospitalité",
      ...
      location: {
        ...
        airport: {
          ...
          description:
            "À seulement 5 minutes de l'aéroport de Francfort – parfait pour les voyageurs avant ou après leur vol",
          stat: "5 Min",
        },
        hotels: {
          title: "Quartier Hôtelier",
          description:
            "Entouré d'hôtels de première classe – idéal pour les voyageurs d'affaires et les invités internationaux",
          stat: "20+",
          statLabel: "Hôtels",
        },
    ...
    menu: {
      ...
      items: {
        breakfast: [
          {
            name: "Petit-déjeuner AeroLounge",
            description: "Croissant, fruits frais, yaourt, café",
            price: "12.90",
          },
          {
            name: "Œufs Bénédicte",
            description: "Œufs pochés, hollandaise, épinards, muffin anglais",
            price: "14.50",
          },
          {
            name: "Toast à l'Avocat",
            description: "Pain au levain, avocat, œuf poché, micropousses",
            price: "11.90",
          },
          {
            name: "Pile de Crêpes",
            description: "Sirop d'érable, baies, crème fouettée",
            price: "10.50",
          },
          {
            name: "Müesli Bircher",
            description: "Fait maison, fruits de saison, noix",
            price: "8.90",
          },
          {
            name: "Pain Perdu",
            description: "Brioche, vanille, banane caramélisée",
            price: "11.50",
          },
        ],
        lunch: [
          {
            ...
            description: "Quinoa, légumes rôtis, beurre citronné",
            price: "22.90",
          },
          {
            name: "Burger Truffe",
            description: "Bœuf, mayo truffée, roquette, frites",
            price: "18.50",
          },
          {
            name: "Salade César",
            description: "Laitue romaine, poulet, parmesan, vinaigrette maison",
            price: "15.90",
          },
          {
            name: "Pâtes Carbonara",
            description: "Tagliatelles maison, guanciale, pecorino",
            price: "16.50",
          },
          {
            name: "Bol Curry Thaï",
            description: "Légumes, lait de coco, riz jasmin, coriandre",
            price: "14.90",
          },
          {
            name: "Steak Wagyu",
            description: "200g, gratin de pommes de terre, légumes de saison",
            price: "34.90",
          },
        ],
        drinks: [
          {
            name: "Espresso Signature",
            description: "Origine unique d'Éthiopie",
            price: "3.50",
          },
          {
            name: "Cappuccino",
            description: "Double espresso, lait moussé",
            price: "4.50",
          },
          {
            name: "Cold Brew",
            description: "Extraction froide 24h, notes de vanille",
            price: "5.20",
          },
          {
            name: "Cocktail Aviation",
            description: "Gin, marasquin, crème de violette, citron",
            price: "12.50",
          },
          {
            name: "Spritz Hugo",
            description: "Prosecco, sirop de fleur de sureau, menthe",
            price: "9.50",
          },
          {
            name: "Limonade Maison",
            description: "Variétés changeantes selon la saison",
            price: "5.50",
          },
        ],
      },
    ...
    contact: {
      ...
      form: {
        ...
        subtitle:
          "Remplissez le formulaire et nous confirmerons votre réservation rapidement",
        name: "Nom",
        email: "Email",
        phone: "Téléphone",
        date: "Date",
        ...
        persons: "Personnes",
        successMessage:
          "Demande de réservation envoyée ! Nous vous contacterons sous peu.",
      },
      map: {
        title: "Nous Trouver",
        ...
        byCar: "En Voiture:",
        byCarText:
          "Autoroute A5, sortie aéroport, direction Terminal 1, tourner à gauche après 500m",
        byPublic: "Transports en Commun:",
        byPublicText:
          'S-Bahn S8/S9 jusqu\'à "Flughafen Regionalbahnhof", 5 min à pied',
    ...
    footer: {
      tagline:
        "Votre escale parfaite près de l'aéroport. Savourez un café de première classe et une cuisine fraîche dans une ambiance moderne.",
  ...
  es: {
    ...
    home: {
      ...
      features: {
        ...
        subtitle:
          "Perfecto para viajeros de negocios, huéspedes internacionales y todos los que aprecian la calidad",
        location: {
      ...
      menu: {
        ...
        breakfast: {
          title: "Desayuno",
          description:
            "Comienza tu día perfectamente con nuestras creaciones frescas",
        },
        lunch: {
          title: "Almuerzo",
      ...
      cta: {
        ...
        subtitle:
          "Reserve su mesa ahora y disfrute de un servicio de primera clase en un ambiente único",
    ...
    about: {
      ...
      values: {
        ...
        passion: {
          title: "Pasión",
          description:
            "Amamos lo que hacemos, desde la preparación del café hasta el servicio",
        },
        quality: {
          title: "Calidad",
          description:
            "Solo los mejores ingredientes y preparación fresca todos los días",
        },
        hospitality: {
          title: "Hospitalidad",
      ...
      location: {
        ...
        airport: {
          ...
          description:
            "A solo 5 minutos del Aeropuerto de Frankfurt: perfecto para viajeros antes o después de su vuelo",
          stat: "5 Min",
        },
        hotels: {
          title: "Distrito Hotelero",
          description:
            "Rodeado de hoteles de primera clase: ideal para viajeros de negocios y huéspedes internacionales",
          stat: "20+",
          statLabel: "Hoteles",
        },
        address: "Flughafenstraße 123, Frankfurt",
    ...
    menu: {
      ...
      items: {
        breakfast: [
          {
            name: "Desayuno AeroLounge",
            description: "Croissant, fruta fresca, yogur, café",
            price: "12.90",
          },
          {
            name: "Huevos Benedict",
            description:
              "Huevos escalfados, holandesa, espinacas, muffin inglés",
            price: "14.50",
          },
          {
            name: "Tostada de Aguacate",
            description:
              "Pan de masa madre, aguacate, huevo escalfado, microvegetales",
            price: "11.90",
          },
          {
            name: "Pila de Panqueques",
            description: "Jarabe de arce, bayas, crema batida",
            price: "10.50",
          },
          {
            name: "Müsli Bircher",
            description: "Casero, frutas de temporada, nueces",
            price: "8.90",
          },
          {
            name: "Tostada Francesa",
            description: "Brioche, vainilla, plátano caramelizado",
            price: "11.50",
          },
        ],
        lunch: [
          {
            ...
            description: "Quinoa, verduras asadas, mantequilla de limón",
            price: "22.90",
          },
          {
            name: "Hamburguesa de Trufa",
            description: "Carne, mayonesa de trufa, rúcula, papas fritas",
            price: "18.50",
          },
          {
            name: "Ensalada César",
            description:
              "Lechuga romana, pechuga de pollo, parmesano, aderezo casero",
            price: "15.90",
          },
          {
            name: "Pasta Carbonara",
            description: "Tagliatelle casero, guanciale, pecorino",
            price: "16.50",
          },
          {
            name: "Bowl de Curry Tailandés",
            description: "Verduras, leche de coco, arroz jazmín, cilantro",
            price: "14.90",
          },
          {
            name: "Filete Wagyu",
            description: "200g, gratín de papa, verduras de temporada",
            price: "34.90",
          },
        ],
        drinks: [
          {
            name: "Espresso Signature",
            description: "Origen único de Etiopía",
            price: "3.50",
          },
          {
            name: "Cappuccino",
            description: "Espresso doble, leche espumada",
            price: "4.50",
          },
          {
            name: "Cold Brew",
            description: "Extracción fría 24h, notas de vainilla",
            price: "5.20",
          },
          {
            name: "Cóctel Aviation",
            description: "Gin, marrasquino, crema de violeta, limón",
            price: "12.50",
          },
          {
            name: "Hugo Spritz",
            description: "Prosecco, jarabe de flor de saúco, menta",
            price: "9.50",
          },
          {
            name: "Limonada Casera",
            description: "Variedades cambiantes según la temporada",
            price: "5.50",
          },
        ],
      },
    ...
    contact: {
      ...
      form: {
        ...
        subtitle:
          "Completa el formulario y confirmaremos tu reserva de inmediato",
        name: "Nombre",
        email: "Email",
        phone: "Teléfono",
        date: "Fecha",
        ...
        persons: "Personas",
        successMessage:
          "¡Solicitud de reserva enviada! Te contactaremos pronto.",
      },
      map: {
        title: "Encuéntranos",
        ...
        byCar: "En Coche:",
        byCarText:
          "Autopista A5, salida aeropuerto, dirección Terminal 1, girar a la izquierda después de 500m",
        byPublic: "Transporte Público:",
        byPublicText:
          'S-Bahn S8/S9 hasta "Flughafen Regionalbahnhof", 5 min a pie',
    ...
    footer: {
      tagline:
        "Tu parada perfecta cerca del aeropuerto. Disfruta de un café de primera clase y cocina fresca en un ambiente moderno.",
      quickLinks: "Enlaces Rápidos",
      contact: "Contacto",
      followUs: "Síguenos",
      copyright:
        "© {year} AeroLounge Café & Bistro. Todos los derechos reservados.",
      privacy: "Privacidad",
      imprint: "Aviso Legal",
      terms: "Términos",
    },
  ...
  tr: {
    ...
    home: {
      ...
      features: {
        ...
        subtitle:
          "İş gezginleri, uluslararası misafirler ve kaliteyi takdir eden herkes için mükemmel",
        location: {
      ...
      cta: {
        ...
        subtitle:
          "Şimdi masanızı rezerve edin ve benzersiz bir ortamda birinci sınıf hizmetin tadını çıkarın",
    ...
    about: {
      ...
      values: {
        ...
        passion: {
          title: "Tutku",
          description:
            "Yaptığımız işi seviyoruz – kahve hazırlıktan servise kadar",
        },
        quality: {
          title: "Kalite",
      ...
      location: {
        ...
        airport: {
          ...
          description:
            "Frankfurt Havaalanı'na sadece 5 dakika – uçuştan önce veya sonra gezginler için mükemmel",
          stat: "5 Dk",
        },
        hotels: {
          title: "Otel Bölgesi",
          description:
            "Birinci sınıf otellerle çevrili – iş gezginleri ve uluslararası misafirler için ideal",
          stat: "20+",
          statLabel: "Otel",
        },
        address: "Flughafenstraße 123, Frankfurt",
    ...
    menu: {
      ...
      items: {
        breakfast: [
          {
            name: "AeroLounge Kahvaltısı",
            description: "Kruvasan, taze meyve, yoğurt, kahve",
            price: "12.90",
          },
          {
            name: "Eggs Benedict",
            description: "Poşe yumurta, hollandaise, ıspanak, İngiliz çöreği",
            price: "14.50",
          },
          {
            name: "Avokado Tostu",
            description:
              "Ekşi maya ekmeği, avokado, poşe yumurta, mikro yeşillikler",
            price: "11.90",
          },
          {
            name: "Pankek Yığını",
            description: "Akçaağaç şurubu, yaban mersini, krem şanti",
            price: "10.50",
          },
          {
            name: "Bircher Müsli",
            description: "Ev yapımı, mevsim meyveleri, fındık",
            price: "8.90",
          },
          {
            name: "Fransız Tostu",
            description: "Brioche, vanilya, karamelize muz",
            price: "11.50",
          },
        ],
        lunch: [
          {
            ...
            description: "Kinoa, kavrulmuş sebzeler, limon tereyağı",
            price: "22.90",
          },
          {
            name: "Trüf Burger",
            description: "Sığır eti, trüf mayonez, roka, patates kızartması",
            price: "18.50",
          },
          {
            name: "Sezar Salatası",
            description: "Marul, tavuk göğsü, parmesan, ev yapımı sos",
            price: "15.90",
          },
          {
            name: "Makarna Carbonara",
            description: "Ev yapımı tagliatelle, guanciale, pecorino",
            price: "16.50",
          },
          {
            name: "Tay Köri Kasesi",
            description:
              "Sebzeler, hindistan cevizi sütü, yasemin pirinci, kişniş",
            price: "14.90",
          },
          {
            name: "Wagyu Biftek",
            description: "200g, patates graten, mevsim sebzeleri",
            price: "34.90",
          },
        ],
        drinks: [
          {
            name: "İmza Espresso",
            description: "Etiyopya'dan tek kaynak",
            price: "3.50",
          },
          {
            name: "Cappuccino",
            description: "Çift espresso, köpüklü süt",
            price: "4.50",
          },
          {
            name: "Soğuk Demleme",
            description: "24 saat soğuk çıkarma, vanilya notaları",
            price: "5.20",
          },
          {
            name: "Havacılık Kokteyli",
            description: "Cin, maraschino, menekşe kremi, limon",
            price: "12.50",
          },
          {
            name: "Hugo Spritz",
            description: "Prosecco, mürver çiçeği şurubu, nane",
            price: "9.50",
          },
          {
            name: "Ev Yapımı Limonata",
            description: "Mevsime göre değişen çeşitler",
            price: "5.50",
          },
        ],
      },
    ...
    contact: {
      ...
      form: {
        ...
        persons: "Kişi",
        successMessage:
          "Rezervasyon talebi gönderildi! Kısa süre içinde size ulaşacağız.",
      },
      map: {
        title: "Bizi Bulun",
        ...
        byCar: "Arabayla:",
        byCarText:
          "A5 otoyolu, havaalanı çıkışı, Terminal 1 yönü, 500m sonra sola",
        byPublic: "Toplu Taşıma:",
        byPublicText:
          'S-Bahn S8/S9 ile "Flughafen Regionalbahnhof"a, 5 dk yürüyüş',
        parking: "Park:",
    ...
    footer: {
      tagline:
        "Havaalanına yakın mükemmel durağınız. Modern bir atmosferde birinci sınıf kahve ve taze mutfağın tadını çıkarın.",
  ...
  ar: {
    ...
    home: {
      ...
      cta: {
        ...
        subtitle:
          "احجز طاولتك الآن واستمتع بخدمة من الدرجة الأولى في أجواء فريدة",
        button: "احجز الآن",
      },
    },
    about: {
      ...
      location: {
        ...
        airport: {
          title: "قرب المطار",
          description:
            "على بعد 5 دقائق فقط من مطار فرانكفورت - مثالي للمسافرين قبل أو بعد رحلتهم",
          stat: "5 دقائق",
        },
        hotels: {
          title: "منطقة الفنادق",
          description:
            "محاط بفنادق من الدرجة الأولى - مثالي لرجال الأعمال والضيوف الدوليين",
          stat: "+20",
          statLabel: "فندق",
        },
    ...
    menu: {
      ...
      items: {
        breakfast: [
          {
            name: "إفطار AeroLounge",
            description: "كرواسون، فواكه طازجة، زبادي، قهوة",
            price: "12.90",
          },
          {
            name: "بيض بنديكت",
            description: "بيض مسلوق، هولنديز، سبانخ، كعك إنجليزي",
            price: "14.50",
          },
          {
            name: "توست أفوكادو",
            description: "خبز العجين المخمر، أفوكادو، بيض مسلوق، خضار صغيرة",
            price: "11.90",
          },
          {
            name: "كومة فطائر",
            description: "شراب القيقب، توت، كريمة مخفوقة",
            price: "10.50",
          },
          {
            name: "موسلي بيرشر",
            description: "منزلي الصنع، فواكه موسمية، مكسرات",
            price: "8.90",
          },
          {
            name: "توست فرنسي",
            description: "بريوش، فانيليا، موز مكرمل",
            price: "11.50",
          },
        ],
        lunch: [
          {
            ...
            description: "كينوا، خضار محمصة، زبدة الليمون",
            price: "22.90",
          },
          {
            name: "برجر بالكمأة",
            description: "لحم بقري، مايونيز الكمأة، جرجير، بطاطا مقلية",
            price: "18.50",
          },
          {
            name: "سلطة قيصر",
            description: "خس روماني، صدر دجاج، بارميزان، صلصة منزلية",
            price: "15.90",
          },
          {
            name: "باستا كاربونارا",
            description: "تالياتيلي منزلي الصنع، غوانشيالي، بيكورينو",
            price: "16.50",
          },
          {
            name: "وعاء كاري تايلندي",
            description: "خضار، حليب جوز الهند، أرز ياسمين، كزبرة",
            price: "14.90",
          },
          {
            name: "ستيك واغيو",
            description: "200 جم، غراتان بطاطس، خضار موسمية",
            price: "34.90",
          },
        ],
        drinks: [
          ...
          {
            name: "كابتشينو",
            description: "إسبريسو مزدوج، حليب مزبد",
            price: "4.50",
          },
          {
            name: "قهوة باردة",
            description: "استخلاص بارد لمدة 24 ساعة، نكهات الفانيليا",
            price: "5.20",
          },
          {
            name: "كوكتيل الطيران",
            description: "جن، ماراشينو، كريم فيوليت، ليمون",
            price: "12.50",
          },
          {
            name: "هوغو سبريتز",
            description: "بروسيكو، شراب زهرة البلسان، نعناع",
            price: "9.50",
          },
          {
            name: "ليمونادة منزلية",
            description: "أصناف متغيرة موسمياً",
            price: "5.50",
          },
        ],
      },
    ...
    contact: {
      ...
      map: {
        ...
        byCar: "بالسيارة:",
        byCarText:
          "الطريق السريع A5، مخرج المطار، اتجاه Terminal 1، انعطف يساراً بعد 500 متر",
        byPublic: "المواصلات العامة:",
        byPublicText:
          'S-Bahn S8/S9 إلى "Flughafen Regionalbahnhof"، 5 دقائق مشياً',
    ...
    footer: {
      tagline:
        "محطتك المثالية بالقرب من المطار. استمتع بالقهوة من الدرجة الأولى والمطبخ الطازج في أجواء حديثة.",
